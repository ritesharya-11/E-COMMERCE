...
const Product = () => {
  ...
  return productData ? (
    <div className='border-t-2 pt-10 transition-opacity-500 opacity-100'>
      {/* product Data */}
      ...
      <div className='flex-1'>
        ...
        <div className='flex flex-item-centre gap-1 mt-2'>
        ...
        <button onClick={()=>addToCard(productData._id,size)} className='bg-black text-white px-8 py-3 text-sm active:bggray-700'>ADD TO CART</button>
